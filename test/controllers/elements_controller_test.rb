...
class ElementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create element" do
    assert_difference('Element.count') do
      post elements_url, params: { element: { lyric: @element.lyric, movie: @element.movie, song: @element.song } }
    end
  ...
  test "should update element" do
    patch element_url(@element), params: { element: { lyric: @element.lyric, movie: @element.movie, song: @element.song } }
